...
#define BSP_AUX_IRQ_R            (*((volatile uint32_t *)AUX_IRQ_A))              // Auxiliary Interrupt status register
#define BSP_AUX_ENABLES_R        (*((volatile uint32_t *)AUX_ENABLES_A))          // Auxiliary enables register

#define BSP_AUX_MU_IO_REG_R      (*((volatile uint32_t *)AUX_MU_IO_REG_A))        // Mini Uart I/O Data register
#define BSP_AUX_MU_IER_REG_R     (*((volatile uint32_t *)AUX_MU_IER_REG_A))       // Mini Uart Interrupt Enable register
#define BSP_AUX_MU_IIR_REG_R     (*((volatile uint32_t *)AUX_MU_IIR_REG_A))       // Mini Uart Interrupt Identify register
#define BSP_AUX_MU_LCR_REG_R     (*((volatile uint32_t *)AUX_MU_LCR_REG_A))       // Mini Uart Line Control register
#define BSP_AUX_MU_MCR_REG_R     (*((volatile uint32_t *)AUX_MU_MCR_REG_A))       // Mini Uart Modem Control register
#define BSP_AUX_MU_LSR_REG_R     (*((volatile uint32_t *)AUX_MU_LSR_REG_A))       // Mini Uart Line Status register
#define BSP_AUX_MU_MSR_REG_R     (*((volatile uint32_t *)AUX_MU_MSR_REG_A))       // Mini Uart Modem Status register
#define BSP_AUX_MU_SCRATCH_R     (*((volatile uint32_t *)AUX_MU_SCRATCH_A))       // Mini Uart Scratch register
#define BSP_AUX_MU_CNTL_REG_R    (*((volatile uint32_t *)AUX_MU_CNTL_REG_A))      // Mini Uart Extra Control register
#define BSP_AUX_MU_STAT_REG_R    (*((volatile uint32_t *)AUX_MU_STAT_REG_A))      // Mini Uart Extra Status register
#define BSP_AUX_MU_BAUD_REG_R    (*((volatile uint32_t *)AUX_MU_BAUD_REG_A))      // Mini Uart Baudrate register

#define BSP_AUX_SPI_1_CNTL0_REG_R (*((volatile uint32_t *)AUX_SPI_1_CNTL0_REG_A)) // SPI 1 Control register 0 register
#define BSP_AUX_SPI_1_CNTL1_REG_R (*((volatile uint32_t *)AUX_SPI_1_CNTL1_REG_A)) // SPI 1 Control register 1 register
#define BSP_AUX_SPI_1_STAT_REG_R  (*((volatile uint32_t *)AUX_SPI_1_STAT_REG_A))  // SPI 1 Status register
#define BSP_AUX_SPI_1_IO_REG_R    (*((volatile uint32_t *)AUX_SPI_1_IO_REG_A))    // SPI 1 Data register
#define BSP_AUX_SPI_1_PEEK_REG_R  (*((volatile uint32_t *)AUX_SPI_1_PEEK_REG_A))  // SPI 1 Peek register

#define BSP_AUX_SPI_2_CNTL0_REG_R (*((volatile uint32_t *)AUX_SPI_2_CNTL0_REG_A)) // SPI 2 Control register 0 register
#define BSP_AUX_SPI_2_CNTL1_REG_R (*((volatile uint32_t *)AUX_SPI_2_CNTL1_REG_A)) // SPI 2 Control register register
#define BSP_AUX_SPI_2_STAT_REG_R  (*((volatile uint32_t *)AUX_SPI_2_STAT_REG_A))  // SPI 2 Status register
#define BSP_AUX_SPI_2_IO_REG_R    (*((volatile uint32_t *)AUX_SPI_2_IO_REG_A))    // SPI 2 Data address
#define BSP_AUX_SPI_2_PEEK_REG_R  (*((volatile uint32_t *)AUX_SPI_2_PEEK_REG_A))  // SPI 2 Peek address
